...
"""
xdata_er = np.std(xdata)
ydata_er = np.std(ydata)
...
xdiff_corrected_sq_er = exprop(2, np.mean(xdiff_corrected), xdiff_corrected_er)
ydiff_corrected_sq_er = exprop(2, np.mean(ydiff_corrected), ydiff_corrected_er)
sum_of_squares_er = adsubprop(xdiff_corrected_sq_er, ydiff_corrected_sq_er)
step_size_er = exprop(0.5, np.mean(xdiff_corrected)**2 + np.mean(ydiff_corrected**2), sum_of_squares_er)
