...
SOURCE  = "C:\\Users\\skynet\\lab_data" 
...
print("D (Rayleigh): ", D_rayleigh.n, "+/-", D_rayleigh.s)
...
print("D (Maximum Likelihood): ", D_max_likelihood.n, "+/-", D_max_likelihood.s)
...
plt.hist(distances, bins=100, density=True, color='lightcyan', edgecolor='black')  # Set bins to 20
